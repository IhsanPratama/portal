...
class Beranda_controller extends Controller
{
    public function index(){
        $artikel = \DB::table('artikel as a')->join('kategori as k','k.id','=','a.id_kategori')->select('a.judul','a.isi','a.gambar','a.created_at','k.nama as kategori','a.artikel_id')->orderby('created_at','desc')->paginate(1);
    ...
    public function artikel_kategori($kategori_id){
        $data = \DB::table('artikel as a')->join('kategori as k','k.id','=','a.id_kategori')->where('a.id_kategori',$kategori_id)->select('a.judul','a.isi','a.gambar','a.created_at','k.nama as kategori','a.artikel_id')->orderby('created_at','desc')->get();
